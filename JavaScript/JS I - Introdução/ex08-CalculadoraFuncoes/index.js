...
function calcularAreaTrapezio() {
  ...
  const baseMenor = parseFloat(prompt("Informa a base menor do trapézio:"));
  const altura = prompt("Informa a altura do trapézio:");
  return ((baseMaior + baseMenor) * altura) / 2;
}
function calcularAreaCirculo() {
  const raio = prompt("Informe o raio do círuclo:");
